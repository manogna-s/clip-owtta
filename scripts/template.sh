...
# CUDA_VISIBLE_DEVICES=${GPU_ID} python tta_rosita.py --tesize 50000 --dataset ImagenetCOOD --strong_OOD MNIST  --model ${MODEL} --tta_method ${TTA_METHOD} --classifier_type ${CLASSIFIER_TYPE}
# CUDA_VISIBLE_DEVICES=${GPU_ID} python tta_rosita.py --tesize 50000 --dataset ImagenetCOOD --strong_OOD SVHN   --model ${MODEL} --tta_method ${TTA_METHOD} --classifier_type ${CLASSIFIER_TYPE}
# CUDA_VISIBLE_DEVICES=${GPU_ID} python tta_rosita.py --tesize 50000 --dataset ImagenetR30kOOD --strong_OOD MNIST  --model ${MODEL} --tta_method ${TTA_METHOD} --classifier_type ${CLASSIFIER_TYPE}
# CUDA_VISIBLE_DEVICES=${GPU_ID} python tta_rosita.py --tesize 50000 --dataset ImagenetR30kOOD --strong_OOD SVHN   --model ${MODEL} --tta_method ${TTA_METHOD} --classifier_type ${CLASSIFIER_TYPE}
# CUDA_VISIBLE_DEVICES=${GPU_ID} python tta_rosita.py --tesize 50000 --dataset Visda50kOOD --strong_OOD MNIST  --model ${MODEL} --tta_method ${TTA_METHOD} --classifier_type ${CLASSIFIER_TYPE}
# CUDA_VISIBLE_DEVICES=${GPU_ID} python tta_rosita.py --tesize 50000 --dataset Visda50kOOD --strong_OOD SVHN   --model ${MODEL} --tta_method ${TTA_METHOD} --classifier_type ${CLASSIFIER_TYPE}
